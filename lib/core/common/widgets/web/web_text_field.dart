...
class WebTextField<T> extends StatefulWidget {
  const WebTextField({
    super.key,
    this.controller,
    this.onTap,
                ...
                decoration: InputDecoration(
                  ...
                  border: OutlineInputBorder(
                    borderSide: BorderSide(
                      color: !widget.enabled
                          ? AppColors.grey
                          : widget.borderSideColor ?? AppColors.borderColor,
                  ...
                  fillColor: widget.fillColor ?? AppColors.overlay,
