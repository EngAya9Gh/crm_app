...
DistinctiveClient distinctiveClientFromJson(String str) =>
    DistinctiveClient.fromJson(json.decode(str));

String distinctiveClientToJson(DistinctiveClient data) =>
...
class DistinctiveClient with _$DistinctiveClient {
  ...
  factory DistinctiveClient.fromJson(Map<String, dynamic> json) =>
      _$DistinctiveClientFromJson(json);
}
