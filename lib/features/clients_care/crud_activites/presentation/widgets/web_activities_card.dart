...
class WebActivityListItem extends StatelessWidget {
  final ClientActivityModel activity;
  final bool isCare ;
  final bool isClient;
  const WebActivityListItem({Key? key, required this.activity, this.isCare = false, this.isClient= false}) : super(key: key);
