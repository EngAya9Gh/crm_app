import 'package:crm_smart/features/clients_care/client_activites/presentation/widgets/web_crud_activities_card.dart';
      ...
      builder: (context, state) {
        ...
        return AppPaginatedList(
          ...
          itemBuilder: (context, index) =>
              WebCrudActivityListItem(activity: _bloc.state.clientActivities[index]),
        );
      },
    );
  }
