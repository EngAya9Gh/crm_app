...
@injectable
class GetAllCareActivitiesUseCase extends BaseUsecase<
   ResponseWrapper<List<ClientActivityModel>>, GetAllCareActivitiesParams> {
  GetAllCareActivitiesUseCase(this.repository);

  final CareActivitiesRepository repository;

  @override
  Future<ResponseWrapper<List<ClientActivityModel>>> call(
      GetAllCareActivitiesParams params) {
    return repository.getAllCareActivities(params.toMap());
  }
}

class GetAllCareActivitiesParams {
  final int page;
  final String? filter;
  final int? limit;
