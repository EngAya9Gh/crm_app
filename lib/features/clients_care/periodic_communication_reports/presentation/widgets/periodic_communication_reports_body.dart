...
class PeriodicCommunicationReportsBody extends StatelessWidget {
  const PeriodicCommunicationReportsBody({super.key});

  @override
  Widget build(BuildContext context) {
    final _cubit = context.read<PeriodicCommunicationReportsCubit>();
