...
class FilterClientsInstallReportsSheet extends StatefulWidget {
  const FilterClientsInstallReportsSheet({super.key});

  @override
  State<FilterClientsInstallReportsSheet> createState() =>
      _FilterClientsInstallReportsSheetState();
}

class _FilterClientsInstallReportsSheetState
    extends State<FilterClientsInstallReportsSheet> {
  late final ClientsInstallReportsCubit _cubit;

  @override
  void initState() {
    _cubit = context.read<ClientsInstallReportsCubit>();
  ...
  void _filterAndCloseDialog() {
    _cubit.getClientsInstallReports();
