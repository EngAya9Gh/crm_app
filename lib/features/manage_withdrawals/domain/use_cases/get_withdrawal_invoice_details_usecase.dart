...
@injectable
class GetWithdrawalInvoiceDetailsUsecase
    extends UseCase<Result<ResponseWrapper<List<InvoiceWithdrawalSeries>>>, GetWithdrawalInvoiceDetailsParams> {
  GetWithdrawalInvoiceDetailsUsecase(this._repository);

  final ManageWithdrawalsRepository _repository;

  @override
  Future<Result<ResponseWrapper<List<InvoiceWithdrawalSeries>>>> call(GetWithdrawalInvoiceDetailsParams params) {
