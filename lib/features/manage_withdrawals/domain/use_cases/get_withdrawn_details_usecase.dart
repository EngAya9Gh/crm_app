...
@injectable
class GetWithdrawnDetailsUsecase
    extends UseCase<Result<ResponseWrapper<WithdrawnDetailsModel>>, GetWithdrawnDetailsParams> {
  GetWithdrawnDetailsUsecase(this.repository);

  final ManageWithdrawalsRepository repository;

  @override
  Future<Result<ResponseWrapper<WithdrawnDetailsModel>>> call(GetWithdrawnDetailsParams params) {
