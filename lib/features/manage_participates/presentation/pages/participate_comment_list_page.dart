...
class ParticipateCommentListPage extends StatefulWidget {
  final String participateId;
   ParticipateCommentListPage({Key? key,required this.participateId}) : super(key: key);

  @override
  State<ParticipateCommentListPage> createState() => _ParticipateCommentListPageState();
}

class _ParticipateCommentListPageState extends State<ParticipateCommentListPage> {
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          onPressed: () {
                            ...
                            if (!isValid) return;
                            context.read<ParticipateListBloc>().add(AddParticipateCommentEvent(
                              ...
                              ,onSuccess: (value) {
                                if (value != null) {
                                  ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('errorً')));
                                      return;
                                  }
