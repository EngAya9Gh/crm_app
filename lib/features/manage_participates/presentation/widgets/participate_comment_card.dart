                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            CircleAvatar(
                              radius: 20,
                              child:
                              comment.imgImage.toString().trim().length==0
                              // ||usermodell.img_thumbnail.toString().trim().isEmpty
                                  ? comment.nameUser.toString().isEmpty||comment.nameUser==null
                                  ? Icon(
                                Icons.person,
                                size: 50,
                                color: Colors.lightBlueAccent,
                              ) : Text(comment.nameUser.toString().substring(0, 1))
                                  :  ClipRRect(
                                ...
                                imageUrl: comment.imgImage!=''? urlimage+ comment.imgImage.toString():'',
                              ),
                                  ),
                            ),
                            SizedBox(width: 10,),
                            Column(
                              ...
                              children: [
                                TextUtilis(
                                  ...
                                  textstring: getnameshort(comment.nameUser.toString()),
                                ...
                                TextUtilis(
                                  ...
                                  textstring:comment.dateComment!=null? Utils.toDateTime(
                                     DateTime.parse(
                        ...
                        GestureDetector(
                          onLongPress: () {
                            Clipboard.setData(new ClipboardData(text: comment.content??'')).then((_){
