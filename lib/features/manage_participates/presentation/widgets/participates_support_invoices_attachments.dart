...
class ParticipatesSupportInvoicesAttachments extends StatefulWidget {
  const ParticipatesSupportInvoicesAttachments({
    Key? key,
    required this.onDeleteFileAttach,
  });

  final ValueChanged<FileAttach> onDeleteFileAttach;

  @override
  State<ParticipatesSupportInvoicesAttachments> createState() =>
      _ParticipatesSupportInvoicesAttachmentsState();
}
