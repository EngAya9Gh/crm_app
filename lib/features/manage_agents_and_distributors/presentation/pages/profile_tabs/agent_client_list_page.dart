    ...
    return Directionality(
      ...
      child: BlocBuilder<AgentsDistributorsProfileBloc,
        ...
        builder: (context, state) {
          ...
          // return state.agentClientsListState.when(
          //   init: () => CustomLoadingIndicator(),
          ...
          //               itemBuilder: (BuildContext context, int index) =>
          //                   CardClient(
          //                 clientModel: state.agentClientsListState.data[index],
          //                 //   AgentClientCard(
          //                 // client: state.particiPateClientsListState.data[index],
          //               ),
          //               // ClientCard(client:state.particiPateClientsListState.data[index]),
          //               separatorBuilder: (BuildContext context, int index) =>
          //                   SizedBox(height: 10),
          //               itemCount: state.agentClientsListState.data.length,
          //             ),
          //           ),
          //         ),
          //       ],
