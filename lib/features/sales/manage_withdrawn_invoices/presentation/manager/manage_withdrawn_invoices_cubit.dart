...
class ManageWithdrawnInvoicesCubit extends Cubit<ManageWithdrawnInvoicesState>
  ...
  ManageWithdrawnInvoicesState? fromJson(Map<String, dynamic> json) {
    try {
      filterEntity.statusNotifier.value =WithdrawalInvoiceStatusEnum.values.firstWhereOrNull(
                (element) =>
                    element.value ==
                    json[AppStrings.manageWithdrawnInvoice.statusNotifier],
              ) ??
      ...
      filterEntity.branchNotifier.value =json[AppStrings.manageWithdrawnInvoice.branchNotifier] == null
              ? []
              : (json[AppStrings.manageWithdrawnInvoice.branchNotifier]
                      as List<dynamic>).map((e) => BranchModel.fromJson(e)).toList();
  ...
  Map<String, dynamic>? toJson(ManageWithdrawnInvoicesState state) {
    return {
      AppStrings.manageWithdrawnInvoice.statusNotifier:
          filterEntity.statusNotifier.value.toString(),
      ...
      if (filterEntity.withDrawnUser.value != null)
        AppStrings.manageWithdrawnInvoice.withDrawnUser:filterEntity.withDrawnUser.value!.toJson(),
