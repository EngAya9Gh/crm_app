...
class ClientsDebtsReportsBody extends StatelessWidget {
  const ClientsDebtsReportsBody({super.key});

  @override
  Widget build(BuildContext context) {
    final _cubit = context.read<ClientsDebtsReportsCubit>();
