...
class FilterProductsSalesReportsSheet extends StatefulWidget {
  const FilterProductsSalesReportsSheet({super.key});

  @override
  State<FilterProductsSalesReportsSheet> createState() =>
      _FilterProductsSalesReportsSheetState();
}

class _FilterProductsSalesReportsSheetState extends State<FilterProductsSalesReportsSheet> {
  ...
  void _filterAndCloseDialog() {
    _cubit.getProductsSalesReports();
