...
class ClientsStatusReportsBody extends StatelessWidget {
  const ClientsStatusReportsBody({super.key});

  @override
  Widget build(BuildContext context) {
    final _cubit = context.read<ClientsStatusReportsCubit>();
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          CustomBarChart(
            dataList: _cubit.pageVariables.allList,
            title: 'المبيعات',
            isTransposed: true,
          ),
