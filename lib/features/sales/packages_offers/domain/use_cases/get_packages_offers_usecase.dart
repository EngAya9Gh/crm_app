...
@injectable
class GetPackagesOffersUseCase extends UseCaseNoParam<Either<String, List<PackageOfferModel>>> {
  GetPackagesOffersUseCase(this.repository);

  final PackagesOffersRepository repository;

  @override
  Future<Either<String, List<PackageOfferModel>>> call() {
    return repository.getPackagesOffers();
  }
}
