...
@injectable
class GetPrivilegesUsecase extends UseCase<Result<ResponseWrapper<List<PrivilegeModel>>>, GetPrivilegesParams> {
  GetPrivilegesUsecase(this._repository);

  final PrivilegeRepository _repository;

  @override
  Future<Result<ResponseWrapper<List<PrivilegeModel>>>> call(GetPrivilegesParams params) {
