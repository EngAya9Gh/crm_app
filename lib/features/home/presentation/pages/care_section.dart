...
import '../../../clients_care/periodic_communication_reports/presentation/pages/periodic_communication_reports_page.dart';
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            if (context.read<PrivilegeCubit>().checkPrivilege('104'))
              SelectCategory(
                onTap: () =>
                    AppNavigator.push(PeriodicCommunicationReportsPage()),
