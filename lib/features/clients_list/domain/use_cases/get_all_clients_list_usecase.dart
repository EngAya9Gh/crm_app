...
@injectable
class GetAllClientsListUseCase
    extends UseCase<Result<ResponseWrapper<List<ClientModel>>>, GetAllClientsListParams> {
...
class GetAllClientsListParams {
  ...
  GetAllClientsListParams({required this.country,required this.page,required this.perPage,});

  Map<String, dynamic> toMap() => {'fk_country': this.country,'page': this.page.toString(),'row_in_page': this.perPage.toString(),};
}
