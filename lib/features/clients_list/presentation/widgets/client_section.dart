            ...
            child: Padding(
              ...
              child: SingleChildScrollView(
                child: Column(
                      ...
                      Row(
                        children: [
                          ...
                          (context.read<PrivilegeCubit>().checkPrivilege('133') == true)
                              ? IconButton(
                                  onPressed: () {
                                    if ((context.read<PrivilegeCubit>().checkPrivilege('147') == true)) context.read<ClientProvider>().setTagClient();
                                  },
                                  icon: Icon(
                  ...
                  GestureDetector(
                      onLongPress: () async {
                        await Clipboard.setData(ClipboardData(text: clientModel.serialNumber.toString())).then((value) => ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                content: Text(
                  ...
                  clientModel.size_activity != null ? cardRow(title: 'حجم النشاط', value: clientModel.size_activity.toString()) : Container(),
                  clientModel.email != null ? cardRow(title: 'البريد الالكتروني', value: clientModel.email.toString()) : Container(),
                  ...
                  clientModel.phone == '' || clientModel.phone == null ? Container() : cardRow(title: ' رقم آخر', value: clientModel.phone.toString()),

                  cardRow(title: 'حالة العميل', value: clientModel.typeClient.toString()),
                  clientModel.typeClient == 'مستبعد' ? cardRow(value: clientModel.nameuserdoning.toString(), title: 'قام بتحويل حالة العميل') : Container(),
                  clientModel.typeClient == 'مستبعد' ? cardRow(value: clientModel.dateChangetype.toString(), title: 'تاريخ تحويل حالة العميل') : Container(),
                  clientModel.typeClient == 'مستبعد' ? cardRow(value: clientModel.reasonChange.toString(), title: 'تفاصيل الاستبعاد') : Container(),
                  clientModel.typeClient == 'مستبعد' ? cardRow(value: clientModel.NameReason_reject.toString(), title: 'سبب الاستبعاد') : Container(),
                  clientModel.offer_price != null && clientModel.offer_price.toString().trim().isNotEmpty ? cardRow(title: 'مبلغ عرض السعر', value: clientModel.offer_price.toString()) : Container(),

                  clientModel.offer_price != null && clientModel.offer_price.toString().trim().isNotEmpty ? cardRow(title: 'تاريخ عرض السعر', value: clientModel.date_price.toString()) : Container(),
                  ...
                  if (clientModel.reasonTransfer != null)
                    ...
                    clientModel.fkusertrasfer != null ? cardRow(title: 'قام بتحويل العميل', value: getnameshort(clientModel.nameusertransfer.toString())) : Container(),

                  context.read<PrivilegeCubit>().checkPrivilege('150') == true && (clientModel.reasonTransfer != null) && clientModel.fkusertrasfer != null
                  ...
                  clientModel.fkusertrasfer != null ? cardRow(title: 'تاريخ التحويل', value: clientModel.dateTransfer.toString()) : Container(),

                  clientModel.location.toString() == '' ? Container() : cardRow(title: ' الموقع', value: clientModel.location.toString()),

                  clientModel.ismarketing == '1' ? cardRow(title: ' عميل تسويق الكتروني', value: clientModel.ismarketing == '1' ? 'نعم' : '') : Container(),

                  cardRow(title: 'عنوان العميل', value: clientModel.address_client == null ? '' : clientModel.address_client.toString()),

                  clientModel.presystem == null || clientModel.presystem.toString().trim().isEmpty
                      ? Container()
                      : cardRow(title: 'نظام سابق', value: clientModel.presystemtitle == null ? '' : clientModel.presystemtitle.toString()),

                  cardRow(title: 'مصدر العميل', value: clientModel.sourcclient == null ? '' : clientModel.sourcclient.toString()),
                  if (clientModel.sourcclient == 'عميل موصى به') cardRow(title: 'تمت التوصية من:', value: clientModel.NameClient_recomand == null ? '' : clientModel.NameClient_recomand.toString()),

                  clientModel.activity_type_fk == null ? cardRow(title: 'نوع النشاط', value: clientModel.activity_type_title.toString()) : Container(),

                  clientModel.activity_type_fk == null ? cardRow(title: 'وصف النشاط', value: clientModel.descActivController.toString()) : Container(),
                  ...
                  widget.clienttransfer == null || context.read<PrivilegeCubit>().checkPrivilege('150') == true
                      ...
                      clientModel.reasonTransfer == Provider.of<UserProvider>(context, listen: false).currentUser.idUser.toString()
                          ? Center(
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                                      ...
                                                      ElevatedButton(
                                                        ...
                                                        onPressed: () async {
                                                          ...
                                                          Provider.of<ClientProvider>(context, listen: false).setfkUserApprove({
                                                            ...
                                                            'fkuser': Provider.of<UserProvider>(context, listen: false).currentUser.idUser.toString(),
                                                            //user reciept
                                                            // 'nameusertransfer':
                                                            // Provider.of<user_vm_provider>(context,listen: false)
                                                            //     .currentUser.nameUser.toString(),//الموظف الذي حول العميل
                                                            'name_enterprise': clientModel.nameEnterprise,
                                                            'fk_regoin': Provider.of<UserProvider>(context, listen: false).currentUser.fkRegoin.toString(),
                                                            //'idclient':
                                                          }, widget.idclient).then((value) => value != false ? clear() : error());
                                                        },
                                                        child: Text('نعم'),
                                                      ),
                                                      new ElevatedButton(
                                                  ...
                                                  child: AlertDialog(
                                                    ...
                                                    actions: <Widget>[
                                                      new ElevatedButton(
                                                        ...
                                                        onPressed: () async {
                                                          Provider.of<ClientProvider>(context, listen: false).setfkUserApprove({
                                                            'userrefuse': Provider.of<UserProvider>(context, listen: false).currentUser.nameUser,
                                                            ...
                                                            'name_enterprise': clientModel.nameEnterprise,
                                                          }, widget.idclient).then((value) => value != false ? clear() : error() // clear()
                                                      ...
                                                      ElevatedButton(
                                                        ...
                                                        onPressed: () async {
                                                          ...
                                                          Provider.of<invoice_vm>(context, listen: false).setApproveclient_vm({
                                                            ...
                                                            //"message":"",//
                                                            "nameuserApproved": Provider.of<UserProvider>(context, listen: false).currentUser.nameUser,
                                                            "iduser_approve": Provider.of<UserProvider>(context, listen: false).currentUser.idUser //معتمد الاشتراك
                                                          }, widget.invoice!.idInvoice).then((value) => value != false ? clear() : error() // clear()
                                                              // _scaffoldKey.currentState!.showSnackBar(
                                                              //     SnackBar(content: Text('هناك مشكلة ما')))
                                                              );
                                                        },
                                              ...
                                              actions: <Widget>[
                                                ElevatedButton(
                                                  ...
                                                  onPressed: () async {
                                                    ...
                                                    //     .pop(true);
                                                    // update client to approved client
                                                    Provider.of<invoice_vm>(context, listen: false).setApproveFclient_vm({
                                                      "id_clients": widget.invoice!.fkIdClient,
                                                      //'idApproveClient':widget.itemapprove!.idApproveClient,
                                                      ...
                                                      //"message":"",//
                                                      "nameuserApproved": Provider.of<UserProvider>(context, listen: false).currentUser.nameUser,
                                                      "iduser_FApprove": Provider.of<UserProvider>(context, listen: false).currentUser.idUser //معتمد الاشتراك
                                                    }, widget.invoice!.idInvoice).then((value) => value != false ? clear() : error() // clear()
                                                        // _scaffoldKey.currentState!.showSnackBar(
                                                        //     SnackBar(content: Text('هناك مشكلة ما')))
                                                        );
