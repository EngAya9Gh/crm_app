...
import '../../../../ui/widgets/client_widget/app_bottom_sheet.dart';
...
class _ClientsListPageState extends State<ClientsListPage> {
  ...
  void initState() {
    ...
    _clientsListBloc = context.read<ClientsListBloc>()
      ..add(
          GetAllClientsListEvent(fkCountry: fkCountry!, perPage: 20, page: 1));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        floatingActionButton: Provider.of<privilge_vm>(context, listen: true)
                    .checkprivlge('47') ==
                true
                            ...
                            child: InkWell(
                              ...
                              child: Container(
                                ...
                                child: Icon(Icons.filter_alt_rounded,
                                    color: AppColors.grey.shade600, size: 30),
                              ),
                            ),
                          ),
                        ],
                          ...
                          BlocBuilder<ClientsListBloc, ClientsListState>(
                            builder: (context, state) {
                              return state.clientsListState.when(
                                ...
                                empty: () =>
                                    Center(child: Text("لايوجد عملاء")),
                                error: (exception) =>
                              ...
                              loaded: (data) => RefreshIndicator(
                                ...
                                child: ListView.separated(
                                  ...
                                  itemBuilder:
                                    ...
                                    if (index ==
                                        (state.clientsListState.data.length -
                                            1)) {
                                      state.currentPage++;
                                    ...
                                    return clientCardWidget(
                                        clientModel:
                                            state.clientsListState.data[index]);
                                  },
                                  separatorBuilder:
                                      (BuildContext context, int index) =>
                                          SizedBox(height: 10),
