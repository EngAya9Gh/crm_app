...
UserRegionDepartment userRegionDepartmentFromJson(String str) =>
    UserRegionDepartment.fromJson(json.decode(str));

String userRegionDepartmentToJson(UserRegionDepartment data) =>
...
class UserRegionDepartment with _$UserRegionDepartment {
  ...
  factory UserRegionDepartment.fromJson(Map<String, dynamic> json) =>
      _$UserRegionDepartmentFromJson(json);
}
...
class Managements with _$Managements {
  ...
  factory Managements.fromJson(Map<String, dynamic> json) =>
      _$ManagementsFromJson(json);
}
