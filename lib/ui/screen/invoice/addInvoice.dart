...
class _AddInvoiceState extends State<AddInvoice> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      numbranchController.addListener(() {
        isNumberOfBranchesBiggerThanOne.value =
            numbranchController.text.isNotEmpty;
        // num number = 0;
      ...
      if (_invoice != null) {
        ...
        numInvoiceController.text = _invoice!.renewInventory == null
            ? ''
            : _invoice!.renewInventory.toString();
        numPosController.text =
            _invoice!.renewPos == null ? '' : _invoice!.renewPos.toString();
  ...
  void didChangeDependencies() {
    ...
    final selectedSellerType = context.read<InvoiceVm>().selectedSellerType;

    if (currentInvoiceType != null &&
        currentInvoiceType != selectedSellerType?.index.toString()) {
      sellerCommissionRate.clear();
    } else {
      if (_invoice?.rate_participate != null &&
          _invoice?.rate_participate != "") {
    ...
    if (selectedSellerType != SellerTypeEnum.agent) {
      ...
      if (_invoice?.renew_agent != null && _invoice?.renew_agent != "") {
        renewAgentController.text = _invoice!.renew_agent.toString();
      }
    }
  }
          ...
          child: Form(
            ...
            child: ListView(
              ...
              children: [
                ...
                SectionHeader(title: 'معلومات الفاتورة الأساسية'),
                InfoItem(
                ...
                InfoItem(
                  title: AppStrings.labelAmountPaid,
                  isRequired: true,
                  customWidget: AppTextField(
                    hintText: '',
                ...
                Consumer<InvoiceVm>(
                  builder: (context, data, _) {
                    ...
                    return InfoItem(
                      title: AppStrings.labelRenew,
                      isRequired: invoiceHaveProductsOfTypePrograms,
                      customWidget: AppTextField(
                        hintText: "",
                ...
                Consumer<InvoiceVm>(
                  builder: (_, data, __) {
                    bool invoiceHaveProductsOfTypeResources = data
                        .productsInvoiceList
                        .any((element) => element.typeProdRenew == "resources");

                    return InfoItem(
                      title: AppStrings.labelRenew2Year,
                      isRequired: invoiceHaveProductsOfTypeResources,
                      customWidget: AppTextField(
                        hintText: "",
                ...
                InfoItem(
                  title: AppStrings.labelInvoiceSource,
                  isRequired: true,
                  customWidget: CustomDropDown(
                    ...
                    selectedItem: selectedInvoiceSource != null
                        ? ClientSourceEnum.values.firstWhereOrNull(
                            (element) => element.value == selectedInvoiceSource)
                        : null,
                  ),
                ),
                ...
                SectionHeader(title: 'طريقة الدفع والتركيب'),
                InfoItem(
                  title: AppStrings.labelTypePay,
                  isRequired: true,
                ...
                InfoItem(
                  title: AppStrings.labelTypeInstall,
                  isRequired: true,
                  customWidget: Container(
                    padding: EdgeInsets.only(left: 2, right: 2),
                    decoration: BoxDecoration(
                ...
                InfoItem(
                  title: 'عدد المستخدمين والرقم الضريبي',
                  customWidget: Row(
                    children: [
                      Flexible(
                        child: AppTextField(
                ...
                InfoItem(
                  title: 'شعار المؤسسة',
                  customWidget: ValueListenableBuilder<XFile?>(
                ...
                InfoItem(
                  title: AppStrings.labelImage,
                  customWidget: _commercialRecordImage(),
                ),
                InfoItem(
                  title: 'المرفقات الإضافية',
                  customWidget: InvoiceImagesFiles(
                  ...
                  builder: (context, invoice, _) {
                    ...
                    if (selectedSellerType != null &&
                      ...
                      return Column(
                        children: [
                          InfoItem(
                            title: selectedSellerType == SellerTypeEnum.agent
                                ? "اسم الوكيل"
                                : selectedSellerType ==
                                        SellerTypeEnum.collaborator
                                    ? "اسم المتعاون"
                                    : "اسم الموزع",
                            customWidget: SellerWidget(
                          ...
                          Consumer<InvoiceVm>(
                            builder: (context, invoiceVm, _) {
                              final selectedSellerType =
                                  invoiceVm.selectedSellerType;
                              final title =
                              ...
                              WidgetsBinding.instance.addPostFrameCallback((_) {
                                ...
                                } else if (_invoice?.rate_participate != null &&
                                    _invoice?.rate_participate != "" &&
                                    sellerCommissionRate.text.isEmpty) {
                                ...
                                } else if (_invoice?.renew_agent != null &&
                                    _invoice?.renew_agent != "" &&
                                    renewAgentController.text.isEmpty) {
                                  renewAgentController.text =
                              ...
                              if (_invoice?.idInvoice != null) {
                                ...
                                await invoiceVm.AddInvoiceClientVm(
                                  ...
                                  onAddInvoiceSuccess: (InvoiceModel invoice) {
                                    ...
                                    context
                                        .read<comment_vm>()
                                        .addCommentFromAddInvoice(commentModel);
                                  },
                                  onFail: (error) {
  ...
  Map<String, dynamic> _prepareAddInvoiceBody({
    ...
    Map<String, dynamic> body = {
      ...
      'renew_inventory': numInvoiceController.text.isNotEmpty
          ? numInvoiceController.text.toString()
          : null,
      'renew_pos': numPosController.text.isNotEmpty
          ? numPosController.text.toString()
          : null,
    ...
    if (invoiceVm.filesAttach.isNotEmpty) {
      ...
      for (final file in invoiceVm.filesAttach) {
        attachFilesMap["file_types[$fileIndex]"] =
            file.type == 'all' ? null : file.type;
        fileIndex++;
      }
      body.addAll({
        ...attachFilesMap,
