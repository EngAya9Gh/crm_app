...
class _config_viewState extends State<config_view> {
  ...
  TextEditingController _controllerperiod_commincation3 =
      TextEditingController();
  TextEditingController _controllerperiod_commincation1 =
      TextEditingController();
  TextEditingController _controllerperiod_commincation2 =
      TextEditingController();
  TextEditingController _controllerperiod_install_second =
      TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                  ...
                  for (int i = 0;
                    ...
                    switch (Provider.of<config_vm>(context, listen: false)
                          ...
                          Provider.of<config_vm>(context, listen: false)
                              .updateConfig_vm(
                                ...
                                'fk_country': Provider.of<UserProvider>(context,
                                    ...
                                    .toString(),
                                'comm3':
                                    value, //القيمة السابقة لكي اطرح من الوقت
                              },
                                  Provider.of<config_vm>(context, listen: false)
                                      .listofconfig[i]
                                      .id_config);
                      ...
                      case 'period_commincation2':
                        ...
                        break;
                      case 'install_second':
                        if (valueinstall_second !=
                            _controllerperiod_install_second.text) {
                          Provider.of<config_vm>(context, listen: false)
                              .updateConfig_vm(
                                  {
                                'value_config':
                      ...
                      case 'period_complete_install':
                        Provider.of<config_vm>(context, listen: false)
                            .updateConfig_vm(
                                {
                              'value_config': _controllercomplete_install.text
                            },
                                Provider.of<config_vm>(context, listen: false)
                                    .listofconfig[i]
                                    .id_config);
      ...
      body: SingleChildScrollView(
        child: Padding(
          padding:
              const EdgeInsets.only(top: 40.0, right: 10, left: 10, bottom: 10),
