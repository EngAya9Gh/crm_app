                          ...
                          onTap: () async {
                            ...
                            if (_globalKey.currentState!.validate()) {
                              ...
                              Provider.of<invoice_vm>(context, listen: false)
                                ...
                                "namedatareplay": Provider.of<user_vm_provider>(
                                        context,
                                        listen: false)
                                    .currentUser
                                    .nameUser
                  ...
                  child: Column(
                    children: [
                      _invoice!.dateinstall_done == null &&
                          ...
                          ? RowEdit(
                              name: 'تحديد موعد التركيب والتدريب ', des: '')
                          : Container(),
                      SizedBox(
                        height: 10,
                      ),
                              ...
                              child: Row(
                                children: [
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintStyle: const TextStyle(
                                            ...
                                            fontSize: 16,
                                            fontWeight: FontWeight.w500),
                                        hintText: _invoice!.dateinstall_task ==
                                                    null &&
                                                _currentDate ==
                                                    DateTime(1, 1, 1)
                                  ...
                                  _invoice!.dateinstall_task ==
                                          null //first time for set date for client
                                      ? IconButton(
                                          onPressed: () {
                                                          ...
                                                          child: Directionality(
                                                            ...
                                                            child: AlertDialog(
                                                              title: Text(
                                                                  'التأكيد'),
                                                              content: Text(
                                                                  'هل تريد تحويل العميل إلى جاهز للتركيب '),
                                                              actions: <Widget>[
                                                                Column(
                                                                  children: [
                                                                    SizedBox(
