...
class _addParticipateState extends State<addParticipate> {
  ...
  @override
  void initState() {
    name_participate.text = widget.name_participate == null
        ? ''
        : widget.name_participate.toString();
    mobile_participate.text = widget.mobile_participate == null
        ? ''
        : widget.mobile_participate.toString();
    namebank_participate.text = widget.namebank_participate == null
        ? ''
        : widget.namebank_participate.toString();
    numberbank_participate.text = widget.numberbank_participate == null
        ? ''
        : widget.numberbank_participate.toString();
    super.initState();
  }
