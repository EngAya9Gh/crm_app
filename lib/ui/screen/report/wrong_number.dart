                        ...
                        children: [
                          ...
                          Text(
                            Provider.of<communication_vm>(context,listen: true)
                                .list_wrong_number.length.toString(),style: TextStyle(
                              fontFamily: kfontfamily2,fontWeight: FontWeight.bold
                          ),),
                        ],),
                    ),
                                                      ...
                                                      Column(
                                                        ...
                                                        children: [
                                                          Row( mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                            children: [
                                                              Text(
                                                                value.list_wrong_number[index].name_regoin.toString(),
                                                                style: TextStyle(
                                                          ...
                                                          Row(
                                                            ...
                                                            children: [
                                                              Text(
                                                                value. list_wrong_number[index].nameEnterprise.toString(),
                                                                style: TextStyle(
                                                                  fontWeight: FontWeight.bold,
                                                                  fontSize: 12,
                                                                  fontFamily: kfontfamily2,
