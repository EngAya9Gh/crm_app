...
class care_report extends StatefulWidget {
  ...
  @override
  State<care_report> createState() => _care_reportState();
}

class _care_reportState extends State<care_report> {
  ...
  Future<void> getData() async {
    ...
    if (typeproduct == 'العناية') params = '&product=دوري';
    switch (type) {
      case "userSum":
        data = await Api().post(
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                              ...
                              children: [
                                ...
                                CustomCircularChart(dataList: salesresult),
                                Padding(
