...
class client_dashboard extends StatefulWidget {
  client_dashboard(
      {required this.invoiceModel, required this.typeinvoice, Key? key})
      : super(key: key);
...
class _client_dashboard extends State<client_dashboard>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      _clientModel = Provider.of<ClientProvider>(context, listen: false)
          .currentClientModel
          .data;
      // _clientModel =
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
      ...
      child: ModalProgressHUD(
        inAsyncCall:
            Provider.of<ClientProvider>(context, listen: false).isloading,
        child: Scaffold(
          appBar: AppBar(
          ...
          body: Provider.of<ClientProvider>(context, listen: true).isloading ==
                  true
              ? Container()
              : Container(
