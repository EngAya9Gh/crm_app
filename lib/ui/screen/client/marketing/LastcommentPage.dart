...
class lastcomment_page extends StatelessWidget {
  lastcomment_page({Key? key, required this.LastcommentClient})
      : super(key: key);
            ...
            Padding(
              ...
              child: Column(
                children: [
                  CardRow(
                      title: 'المؤسسة',
                      value: LastcommentClient.client_obj!.nameEnterprise
                          .toString()),
                  CardRow(
                      title: 'اسم العميل',
                      value:
                          LastcommentClient.client_obj!.nameClient.toString()),
                  CardRow(
                      title: 'الفرع',
                      value:
                          LastcommentClient.client_obj!.name_regoin.toString()),
                  CardRow(
                      title: 'حالة العميل',
                      value:
                          LastcommentClient.client_obj!.typeClient.toString()),
                  CardRow(
                      title: 'اسم الموظف',
                  ...
                  CardRow(
                      title: 'آخر تعليق',
                      value:
                          LastcommentClient.hoursLastComment.toString() == '-1'
                              ? 'لا بوجد تعليقات'
                              : LastcommentClient.hoursLastComment.toString()),
                ],
              ),
            ),
            Container(
                          ...
                          children: [
                            Expanded(
                              child: ListView.builder(
                                  ...
                                  itemCount:
                                      LastcommentClient.allComment!.length,
                                    ...
                                    return SingleChildScrollView(
                                        child: Padding(
                                            ...
                                            child:
                                                //Text(''),
                                                cardcomment(
                                              commentmodel: LastcommentClient
                                                  .allComment![index],
                                            )));
                                  }),
                            ),
