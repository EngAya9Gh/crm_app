...
class _invoicesAcceptclientState extends State<invoicesAcceptclient> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      Provider.of<invoice_vm>(context, listen: false).getinvoice_Debt(GetIt.I<PrivilegeCubit>());
    ...
    Provider.of<invoice_vm>(context,listen: false).listInvoicesAccept=[];
     ...
     await Provider.of<ClientProvider>(context,listen: false)
       ...
       Provider.of<ClientProvider>(context,listen: false)
          .getallclientAcceptwithprev(GetIt.I<PrivilegeCubit>());
              ...
              child: ListView(
                children: [
                  Row(
                    ...
                    children: [
                      context.read<PrivilegeCubit>().checkPrivilege('94') == true ? //regoin
                      Expanded(
                        child: Padding(
