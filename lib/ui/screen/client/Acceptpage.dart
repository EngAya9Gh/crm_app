...
class _invoicesAcceptclientState extends State<invoicesAcceptclient> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      Provider.of<invoice_vm>(context, listen: false).getinvoice_Localwithprev();
      ...
      await Provider.of<client_vm>(context, listen: false).getallclientAccept();

      Provider.of<client_vm>(context, listen: false).getallclientAcceptwithprev();
    });
            ...
            child: Padding(
                ...
                child: ListView(
                  children: [
                    ...
                    search_widget('waitwithprev', hintnamefilter, ''),
                    Padding(
  ...
  void filtershow() {
    print(regoin);
    print(typeclientvalue);
    Provider.of<invoice_vm>(context, listen: false).getfilterinvoicesclient(typeclientvalue, regoin);
