...
class ClientService {
  ...
  //id_product
  Future<ClientModel1> updateClient(Map<String, dynamic> body, String idclient) async {
  ...
  Future<ClientModel1> setfkuserClient(Map<String, dynamic> body, String idclient) async {
  ...
  List<ClientModel1> convertToClients(List<dynamic> list) {
    return List<Map<String, dynamic>>.from(list).map<ClientModel1>((e) => ClientModel1.fromJson(e)).toList();
  }
  ...
  Future<List<ClientModel1>> getClientDateTable_regoin(String? fkcountry,String regoin) async {
    List<dynamic> data =[];
    data=await Api()
  ...
  Future<List<ClientModel1>> getAllClientsupport(String? fkcountry, List<int>? listparam) async {
    List<dynamic> data = [];
    if (listparam != null) {
      String params = '';
  ...
  Future<List<ClientModel1>> getClientbyuser(String? fk_user) async {
    ...
    List<ClientModel1> prodlist = await compute<List<dynamic>, List<ClientModel1>>(convertToClients, data);
    return prodlist;
  }
