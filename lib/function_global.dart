...
void route_notifyto(
    typeNotify, context, Map<String, dynamic>? data, String? datanotify) {
  switch (typeNotify) {
    case "ApproveRequest":
      Navigator.push(
    ...
    case "ApproveFRequest":
      Navigator.push(context,
          CupertinoPageRoute(builder: (context) => ApproveFinancePage()));
      break;
    case "checkComment":
      Navigator.push(context,
          CupertinoPageRoute(builder: (context) => LatestClientsUpdatesPage()));
      break;
    // todo: add task
    case "task":
      Navigator.push(context,
